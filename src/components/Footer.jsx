          ...
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0 flex items-center flex-col sm:block    ">
              ...
              <a href="mailto:contact@cgfceg.org" className="mt-2 block">
                <span className="self-center text-md sm:ml-12 ml-0 whitespace-nowrap text-white hover:underline underline-offset-2 hover:text-cyan-400">
                  contact@cgfceg.org
                </span>
              </a>
              <div className="flex text-white mt-6 sm:ml-8 m-0">
                <a
                  href="https://instagram.com/cgf_ceg"
                  className="px-3 border-2 rounded-full py-3 mx-3 hover:text-cyan-400 hover:border-cyan-500"
                  target="_blank"
                >
                  <Instagram />
                </a>
                <a
                  href="https://www.facebook.com/cgfceg"
                  className="px-3 border-2 rounded-full py-3 mx-3 hover:text-cyan-400 hover:border-cyan-500"
                  target="_blank"
                >
                  <Facebook />
                ...
                <a
                  href="https://www.linkedin.com/company/cgfceg/"
                  className="px-3 border-2 rounded-full py-3 mx-3 hover:text-cyan-400 hover:border-cyan-500"
                  target="_blank"
                >
                  <Linkedin />
