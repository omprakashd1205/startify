  ...
  return (
    <div>
      <div className="flex items-center justify-center sm:block">
        <div className="sm:ml-20 mt-24 font-title font-bold uppercase text-2xl bg-blue-300 inline-block py-4 px-8 rounded-full">
          Events{" "}
        </div>
      </div>
